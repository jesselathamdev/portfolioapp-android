...
public class HoldingsActivity extends BaseListActivity
{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(app.TAG, "SCREEN: Loaded Holding activity.");
		...
		if (authToken != null) {
		    ...
		    Toast.makeText(this, "Holding activity", Toast.LENGTH_SHORT).show();
		}
    }
            ...
            if (e == null && serverResponse != null) {
                ...
                switch (statusCode) {
                    case 200:
                        ...
                        ListAdapter adapter = new PortfolioListAdapter(HoldingsActivity.this, 
                                portfoliosList, 
                        ...
                        HoldingsActivity.this.setListAdapter(adapter);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
	    switch (item.getItemId()) {
	        ...
	        case R.id.menu_signout:
	            ...
	            // start activity
	            startActivity(new Intent(HoldingsActivity.this, SignInActivity.class));
	            HoldingsActivity.this.finish();
